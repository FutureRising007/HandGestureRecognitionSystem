"""
Author: Mohammad Kaif Ahmed: OrionAlpha
"""
import cv2
...
model = load_model(r"D:\The Innovations!!\PROJECTS\HandGestureRecognition System\models\resnetmodel.hdf5")

vid = cv2.VideoCapture(0)
vid.set(cv2.CAP_PROP_FRAME_WIDTH, 400)
vid.set(cv2.CAP_PROP_FRAME_HEIGHT, 400)

labels = pd.read_csv(r'D:\The Innovations!!\PROJECTS\HandGestureRecognition System\jester-v1-labels.csv', header= None)
